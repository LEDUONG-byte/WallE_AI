...
Nạp firmware/esp_wifi_bridge/tcp_bridge.ino cho ESP8266. Dùng điện thoại kết nối vào WiFi Wall-E_Setup để cấu hình mạng LAN nhà bạn.

Nạp firmware/arduino_motor_servo/main.ino cho Arduino Uno (Lưu ý: Rút dây RX/TX trước khi nạp).
...
Tải ứng dụng DroidCam trên điện thoại (Android/iOS).

Kết nối điện thoại cùng chung mạng WiFi với Laptop và Wall-E.

Mở app DroidCam và để màn hình sáng (ứng dụng sẽ phát video ở cổng 4747).
...
Quay Servo kênh 0 tới góc 90 độ (0-180).
...
Điều khiển motor 1 (Trái) với PWM 200.
...
Hai bánh chạy đồng bộ, mục tiêu 10 xung/50ms.
